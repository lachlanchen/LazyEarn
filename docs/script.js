const fallbackStrings = {
  ...
  "research.point4": `Operational additions: household stress dashboard, credit-conditions transmission check, and QE-5/HS-8/LL-6 methods for decision-ready monitoring.`,
  ...
  "research.asset1Desc": `A practical field guide to money and wealth with distinction checklists, evidence ladders, stress dashboards, transmission checks, and source-linked methods you can apply immediately.`,
...
const pdfEntries = {
  "wealth-from-first-principles": {
    ...
    description:
      "A practical field guide to money and wealth with distinction checklists, evidence ladders, stress dashboards, transmission checks, and source-linked methods.",
