...
Once that distinction is drawn, the lecture gives a beginner's entry arithmetic. If the buyer has roughly \$100{,}000 in cash and targets a \$300{,}000 to \$400{,}000 property, then the lecture's spoken example may be unpacked as
\begin{align}
...
His closing compression is equally useful: keep your word, hire great people, and share. In other words, even after the lecture denies the existence of a secret, it still leaves behind a practical rule stack.
