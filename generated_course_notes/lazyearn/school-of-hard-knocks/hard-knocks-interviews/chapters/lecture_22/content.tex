...
\node[draw, rounded corners, minimum width=3.0cm, minimum height=0.9cm] (pd) at (1.3,0) {\shortstack{more product\\and wider distribution}};
\node[draw, rounded corners, minimum width=3.0cm, minimum height=0.9cm] (ig) at (5.1,0) {\shortstack{Instagram, tutorials,\\creator circulation}};
