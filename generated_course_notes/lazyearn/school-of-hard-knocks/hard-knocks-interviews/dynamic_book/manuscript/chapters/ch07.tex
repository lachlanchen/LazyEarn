...
\begin{equation}
\underbrace{C_{\mathrm{delivery}}+C_{\mathrm{capacity}}
  +C_{\mathrm{risk}}+M_{\mathrm{sustainable}}}_{\text{seller's floor}}
\ \leq\ P\ \leq\
\underbrace{V_{\mathrm{buyer}}-V_{\mathrm{best\ alternative}}}_{
  \text{buyer-specific room}}.
\end{equation}
