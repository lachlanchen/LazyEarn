...
Glen Boyd answers the happiness question from the opposite end of the wealth
...
It also explains why arguments about whether money buys happiness so often fail.
...
\begin{equation}
\text{comparison} \longrightarrow \text{higher fixed spending}
