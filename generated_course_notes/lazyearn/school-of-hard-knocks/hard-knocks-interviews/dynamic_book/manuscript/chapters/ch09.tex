...
\longrightarrow\text{trust}\longrightarrow\text{transaction}\\
&\longrightarrow\text{delivery}\longrightarrow\text{return}
\longrightarrow\text{referral}.
\end{aligned}
\end{equation}
...
\longrightarrow\text{specific repair}\longrightarrow
\text{next credible release}.
\end{equation}
...
V_{\mathrm{route}}
=\sum_{t=0}^{T} p_t
  \bigl(R_t-C_{\mathrm{variable},t}-C_{\mathrm{service},t}
  -C_{\mathrm{recovery},t}\bigr)
