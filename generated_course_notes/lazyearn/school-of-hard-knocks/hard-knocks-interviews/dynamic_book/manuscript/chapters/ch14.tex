...
\begin{equation}
\text{input}\longrightarrow\text{transformation}\longrightarrow
\text{distribution}\longrightarrow\text{transaction}\longrightarrow
\text{delivery}\longrightarrow\text{renewal or reuse}.
\end{equation}
...
\section{Separate legal ownership, economics, and control}
...
One interviewee recommends buying cash-flowing small businesses from owners who
