...
\item \textbf{Timing.} Carry forward dated outflows, peak funding, reserve, and
  the later, smaller, and absent-return cases. Match the capital's duration to
  the work.
\item \textbf{Rights and control.} Record economics, votes, vetoes,
  information, collateral, guarantees, covenants, transfer limits, and exit
  choices surrendered to the provider.
