...
\bottomrule
\end{tabular}
\caption{Lecture 21 widens the ownership chapter by forcing a contrast between founder-exit wealth, cash-to-land accumulation, and volatile high-income regimes.}
\end{table}
...
\section{Lecture 21 adds new rules to the stack}
