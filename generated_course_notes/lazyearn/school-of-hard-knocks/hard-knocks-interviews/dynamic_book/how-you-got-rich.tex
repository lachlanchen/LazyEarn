...
\appendix
\chapter{Manuscript Growth Register}
\section{Commit growth from recent Hard Knocks dynamic manuscript updates}

The growth records below are extracted from commit-level diffs and keep only added content so you can track manuscript expansion and added structure without subtraction noise.
...
]{../../../../../references/course-books/school-of-hard-knocks/dynamic-book-commit-additions.md}
