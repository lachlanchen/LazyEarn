...
\begin{figure}[h]
\centering
\begin{tikzpicture}[x=0.85cm,y=0.55cm,scale=0.95,transform shape]
...
\sigma_2^2
+
\frac{2(r_p-r_2)(r_1-r_p)}{(r_1-r_2)^2}\\
...
\draw[->] (5,8) -- (20.8,8) node[below] {Std.\ Dev.\ of Annual Return};
...
\caption{Simplified redraw of the frontier comparison, preserving the truncated horizontal axis beginning at \(5\%\).}
\end{figure}
