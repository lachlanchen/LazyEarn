# How You Got Rich Manuscript: add-only history (commits impacting file)

Scope: recent 15 commits affecting `generated_course_notes/lazyearn/school-of-hard-knocks/hard-knocks-interviews/dynamic_book/how-you-got-rich.tex`.
Metric source: commit-level add-only diff (`git diff parent..commit`, additions only, no deletions).

## d9212b3 (2026-04-16)
- Message: Grow dynamic hard-knocks manuscript without shrinking chapters
- Net edit volume: +32 / -0
- Added structure snippets:
```latex
...
## d165daf (2026-04-16)
- Message: Update dynamic book for lazyearn/school-of-hard-knocks/hard-knocks-interviews
- Net edit volume: +294 / -13
- Added structure snippets:
```latex
...
## 691b9f6 (2026-04-16)
- Message: Add cover for How You Got Rich? dynamic book
- Net edit volume: +7 / -1
- Added structure snippets:
```latex
\begin{titlepage}
