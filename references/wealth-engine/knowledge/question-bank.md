...
| --- | --- |
| Money stock growth vs credit allocation | Not all new money reaches the same sectors or households. |
| Income flow vs wealth stock | High income does not guarantee rising net worth. |
| Average vs median outcomes | Mean statistics can hide broad ownership gaps. |
| Volatility vs ruin risk | Large but survivable drawdowns are different from insolvency events. |
| Productive leverage vs fragile leverage | Some leverage scales output, other leverage amplifies default risk. |
...
| ID | Question | Key distinction | Evidence anchors |
| --- | --- | --- | --- |
| M4 | How do money-creation dynamics differ across high-rate and low-rate regimes? | Policy-rate regime vs credit-cycle regime | Fed H.6, Fed Z.1 historical panels, NBER JST |
| O3 | How much of long-run return is cash yield and earnings growth versus valuation expansion? | Fundamental return vs multiple expansion | SEC filings, FRED series, IMF WEO |
| O4 | At what scale should a builder shift from concentrated private ownership to diversified public ownership? | Concentration alpha vs diversification survival | SCF, IRS SOI, SEC filings |
| L3 | What emergency-liquidity buffer is required across income-volatility tiers? | Static advice vs volatility-aware planning | BLS CEX, BEA personal income, NY Fed household credit |
| L4 | Which leverage types (debt, code, media, process) scale output with the least tail risk? | Financial leverage vs non-financial leverage | Case synthesis + debt panel evidence |
| I2 | Which groups show persistent ownership gaps even after controlling for income? | Access constraint vs savings behavior | Census wealth, SCF, FDIC, HFCS |
| I3 | How do inflation shocks redistribute between borrowers, lenders, and wage earners? | Nominal debt relief vs real wage squeeze | BLS CPI, NY Fed household credit, Fed DFA |
| R2 | Which decision rules reduce "blow-up" probability during speculative booms? | Expected return maximization vs survival optimization | NBER JST, BIS, household credit transitions |
| R3 | How should allocation rules differ across survival, stability, surplus, ownership, and autonomy stages? | One portfolio for all vs stage-specific design | SCF, FDIC, CFPB, BLS CEX |

## Tier 3 research questions (long horizon)
...
## Unanswered priority questions (cycle_015 sharpen pass)
...
| --- | --- | --- | --- | --- |
| U64 | When official liquidity expands (money stock, bank balance-sheet risk appetite, or policy signaling), which channel receives the first net flow to households and small firms: asset-market valuation, mortgage credit, business credit, or wage/transfer relief? | Aggregate liquidity creation vs channel sequencing and beneficiary class | Two aligned windows show no stable lead across channels after liquidity expansion | Fed H.6, Fed Z.1, Fed H.8/H.4.1, Fed SLOOS | If mortgage or business-credit leads, prioritize access-first ownership methods over asset-representation bets. |
| U65 | Does IMF/Fiscal surveillance signaling (Article IV, IMF WEO, IMF Fiscal Monitor) mainly explain durable ownership-entry gains, or mostly temporary valuation and sentiment effects? | Macro narrative signal vs durable ownership mechanisms | Participation and owner-survival gains do not exceed valuation and leverage effects after burden/timing controls | IMF Article IV, IMF WEO, IMF Fiscal Monitor, Fed DFA, Census wealth tables | If durable entry signals fail, label macro-signaling claims as confidence-cycle aids, not durable wealth strategy. |
| U66 | Is rising wealth concentration after 2010 driven more by incumbency-preserving channel structure than by constrained entry conditions under high-flow investment and inflow regimes? | Incumbent compounding vs denied entry/retention squeeze | Entrant first-time owner share and entrant survival improve at the same pace as concentration gains | UNCTAD WESP, UNCTAD WIT, SCF, HMDA modified LAR | If entrant durability weakens while concentration rises, add a hard cap rule for concentration-exposed allocation in method guidance. |
| U67 | In stress episodes, which failure type is least reversible: debt-service stress, productive-capacity displacement, or legal-access architecture lock-in that blocks future ownership entry? | Reversible macro stress vs irreversible wealth-control loss | All three channels revert in the same window with no lagged increase in foreclosure, involuntary exit, or denied-entry markers | Fed DSR/FOR, FDIC unbanked and branch-level exclusion data, HMDA modified LAR, CFPB Making Ends Meet | If any irreversible channel leads, convert the current cycle's leverage recommendations to a lower baseline.
| U68 | Do reform and resilience materials (Dodd-Frank implementation notes, ECB stability releases, BIS governance updates) improve borrower access and owner progression or only stability optics for banks? | Institutional architecture vs realized borrower outcomes | Stability metrics improve while borrower approvals, delinquencies, and ownership progression remain unchanged for two windows | BIS Annual Reports/FSR, ECB financial stability releases, Fed DFAST notices, CFPB small-business credit reports | If borrower outcomes remain flat, publish this as a stability-only intervention in section 9.
| U69 | Under real-energy or transport-constrained conditions (6-12 month horizon), do productive-capacity-led methods outperform debt-led methods on real cash flow and option-value retention? | Real-capacity path vs nominal leverage-led return illusions | Debt-led methods match or beat productive-capacity methods in real cash flow, survivability, and optionality retention under throughput strain | IEA STEO/MER, IEA WEO 2025/2026, Fed DSR/FOR, BEA NIPA real GDP | If debt-led claims fail under strain, restrict leverage intensity and require throughput checks before compounding rules. |

## Evidence gates for cycle_015 unanswered set

- `U64`: require one system-liquidity series and one first-mile recipient series with 1-2 release-window lead-lag mapping.
- `U65`: require decomposition into valuation, participation, burden, and timing before concluding macro-signaling durability.
- `U66`: require one entrant-only concentration denominator and one incumbent-only denominator for every concentration claim.
...
## Unanswered priority questions (cycle_018 sharpen pass)

| ID | Sharpened question | What must be distinguished | What would falsify the working hypothesis | First evidence pull | Decision-use line |
| --- | --- | --- | --- | --- |
| U78 | When money-creation channels rise together (reserves, bank credit, liquidity facilities), which creates the first durable first-mile access to households and smaller firms: base money expansion, intermediation credit, or fiscal liquidity support? | Creation channel (base money vs credit intermediation vs fiscal liquidity) vs durable recipient access | No channel lead exists for new first-mover approvals/entries after two aligned release windows | Fed H.6, Fed H.4.1, Fed H.8, Fed SLOOS, ECB BLS 2025 release notes | Treat channel leadership as a hard rule before sequencing any access-first method in the next method update. |
| U79 | Does apparent wealth ownership gain in official aggregates reflect genuine legal/economic ownership or mainly balance-sheet exposure and temporary valuation claims? | Legal ownership transfer vs valuation exposure vs contractual claim ownership | Official wealth proxies move without corresponding legal-title indicators and no ownership-quality divergence after valuation drawdowns | OECD Wealth Distribution, Census BDS household assets, SEC beneficial-owner and ownership-disclosure datasets, IMF Fiscal Monitor distributions | If legal/economic ownership fails to improve, keep method focus on control-preserving pathways over paper-wealth capture. |
| U80 | Under rising debt stress, which leverage structure breaks first for durable ownership (short-maturity spread, floating-rate debt share, or covenant weakness)? | Leverage quality (maturity/coupon type/covenant) vs level-only debt burden | Debt metrics worsen equally across durable and fragile profiles after stress without structure sensitivity | Fed DSR/FOR, BIS Total Credit, NY Fed SHED, CFPB Making Ends Meet | Escalate downside-risk guardrails by maturity and contract structure before increasing leverage-weighted compounding advice. |
| U81 | To what extent is inequality drift in 2020s wealth accumulation driven by incumbency-preserving returns versus delayed entry and ownership destruction? | Entrant entry and survival vs valuation windfalls; incumbent reinforcement vs entrant loss | Concentration improves while entrant density and entrant survival rise in parallel | OECD wealth data, SCF/PSID concentration tables, HMDA modified LAR, IMF WEO inequality annex | If entry/survival deteriorates when concentration rises, make distributional repair the first test before claiming progress. |
| U82 | Which irreversible risk dominates in a downturn: drawdown-driven valuation reset, credit-access lockout, or ownership-control erosion (foreclosure/liquidation/dilution)? | Reversible market shock vs irreversible access-control loss | All three risks move only reversibly with no lagged increase in control-loss markers | CFPB Making Ends Meet, FDIC charge-off and delinquency dashboards, HMDA modified LAR, Fed DSR/FOR | Base method recommendations on control-loss precedence once any irreversible marker leads valuation noise in the lead-lag test. |
| U83 | Are productive-wealth methods still superior when physical-constraint rails tighten (energy, logistics, storage, permitting), or do they only dominate in slack periods? | Physical-constraint permissive windows vs constrained windows | Productive-wealth methods retain equal advantage under high congestion and high energy-cost windows without explicit throughput guards | IEA STEO/MER, EIA Monthly Energy Review, BEA fixed assets, Fed DSR/FOR | Add throughput checkpoints and cap productive-hypothesis claims in constrained windows until constraint indicators recover. |
| U84 | Which historical episodes should be treated as transmission regime-shifters for today’s chapter flow: Great Depression reforms, 1970s inflation, 2008 post-crisis redesign, or recent regional debt episodes? | Historical shock type vs modern transmission expression | Modern windows show no persistent lead/lag differences against at least two historical comparators after metadata alignment | Federal Reserve historical essays, BIS 2026 review series, IMF Article IV surveillance, ECB stability reports | Use the strongest matched historical comparator only when signal timing differences survive a 2-step lead-lag test. |
| U85 | What is the governance/ethics decision rule under uncertainty: maximize option value (survival and restart capacity), maximize current yield, or maximize participation and agency control? | Optionality-first vs yield-first vs participation-first outcomes | One rule produces superior survivability, participation retention, and irreversibility outcomes under all test windows | OECD household debt and asset concentration, CBO LTBO, SEC governance disclosures, Fed DFA | Codify the primary rule in methods as context-conditioned; switch to participation-first when uncertainty bands widen. |

## Evidence gates for cycle_018 unanswered set

- `U78`: require at least one base-money series, one credit-intermediation series, and one fiscal-liquidity proxy plus explicit 1-2 release-lag ranking. Reject without explicit first-mover channel lead.
- `U79`: require one legal ownership proxy and one valuation-only proxy in the same window before inferring durable ownership gains.
- `U80`: require maturity structure, rate structure, and covenant risk signals before classifying any leverage method as durable.
- `U81`: require entrant-denominator and incumbent-denominator metrics plus at least one ownership-control durability metric.
- `U82`: require one reversible marker and one irreversible marker, plus 1-window lag test, before naming risk order.
...
## Unanswered priority questions (cycle_023 sharpen pass)

| ID | Sharpened question | What must be distinguished | What would falsify the working hypothesis | First evidence pull | Decision-use line |
| --- | --- | --- | --- | --- |
| U102 | In a policy easing cycle, which first-mile channel absorbs the largest share of net new money: SME credit, household mortgage/consumer credit, or valuation channels? | Aggregate base-money growth vs recipient channel activation | If household and SME access rails do not lead valuation channels in the same expansion window | BoJ Financial System Report 2025, Norges Bank FSR 2025 H1, BoT MPR 2025 Q4 | Do not treat policy easing as support for durable wealth unless access channels rise with stable recipient quality. |
| U103 | When deposit-insurance standards tighten, do risk-weighted banks transmit stronger long-horizon ownership-access improvements or only short-term liquidity comfort? | Liquidity support for institutions vs durable access outcomes for new entrants | If owner-entry and approval-quality fail to improve after stronger deposit safety rules | IADI Core Principles (Sep 2025), IADI revised-principles notice, Bank of England/BoJ policy disclosures | Convert institutional safety-net claims into household access claims only after observing first-mile entry persistence improvements. |
| U104 | Do sovereign and corporate debt-structure changes in OECD debt reports predict measurable wealth-entry timing or mostly raise refinancing and valuation fragility? | Macro debt load as financing cost/availability constraint vs direct owner-income channel | If debt metrics improve while entry and long-run owner income do not move, macro debt may be secondary | OECD Global Debt Report 2026, CBO 2026-2036 outlook, IMF/BEA macro links | Pause debt-led scaling methods when debt-service pressure rises faster than owner-entry or cash-flow durability improves. |
| U105 | In non-U.S. financial-system episodes, how much does a liquidity-support narrative overstate ownership control compared with actual entrant-denominator change? | Stability narrative vs ownership-control transfer | If entrant-denominator and duration-adjusted survival metrics do not diverge from official stability messaging | BoJ FSR 2025, Norges FSR 2025 H1, Federal Reserve History material on 1930-31 and 2008 comparators | Add a `must_not_conflate` rule where policy stability signals are reported with ownership outcome claims. |
| U106 | Which historical turning-point ordering best predicts modern transmission in constrained economies: 1930s closures, 1973-74 energy tightening, or 2008 market-reset redesign? | Event label vs measurable channel ordering (credit, debt-service, asset-entry) | If channel ordering fails to repeat in two modern windows, discard comparator as a direct guide | Federal Reserve historical essays, BIS Quarterly Review (2026), ECB/Norges/BoJ comparator pages | Keep one historical comparator only when two modern windows confirm the same lead-lag hierarchy before route rule design. |
| U107 | Which wealth-building method is most robust when energy, logistics, and replacement-speed constraints worsen simultaneously: leveraged build-up, cash-flow compounding, or staged re-entry? | Constraint-safe compounding vs debt-amplified nominal gains | If leveraged and cash-flow methods perform equally under constraint stress, method split is unnecessary | OECD Global Debt Report 2026, EIA STEO, IEA oil/energy outlooks, USGS mineral summaries | Force a constraint-mode branch in methods where throughput recovery lags cash-flow recovery. |
| U108 | How should irreversible markers (foreclosure, long-delayed replacement, or credit denial lockout) be weighted against reversible spread or price volatility in cycle staging? | Reversible stress vs irreversible access loss | If lockout/denial markers do not precede repeated volatility spikes, stage gates are over-conservative | CFPB Making Ends Meet, FDIC bank failure/foreclosure data, Fed DSR/FOR, IMF debt risk signals | Use irreversible lockout markers as a higher-tier stop condition than volatility-only comfort metrics. |
| U109 | In high-uncertainty windows, should optionality, control, or liquidity be the primary principle for method choice, and what switches that priority? | Philosophy-first decision rule vs mechanism-first mechanism | If one principle does not lose rank when uncertainty and constraint bands widen, rules are likely overfitted | BoT MPR 2025 Q4, OECD IDD/WDD, IADI governance framework, Fed DFA | Write explicit regime-switch language: optionality-first under access erosion, control-first under rising lockout risk, liquidity-only only for re-entry bridging. |

## Evidence gates for cycle_023 unanswered set

- `U102`: require aligned release-window ranking among BoJ/Norges/BoT and one domestic recipient-channel metric before stating any channel lead.
- `U103`: require one deposit-insurance institutional metric and one first-mile entry metric before converting depositor stability into ownership claims.
- `U104`: require sovereign/corporate debt changes plus household entry and borrower-survival rails before ranking debt-related methods as durable.
- `U105`: require one entrant-denominator and one incumbent-denominator metric before any narrative that equates stability with access.
- `U106`: require two modern windows with matching lead-lag before using any historical sequence as a direct route guide.
- `U107`: require replacement lead-time, throughput, and cash-flow persistence before recommending leverage in constrained periods.
- `U108`: require one reversible and one irreversible marker series before setting any stage stop line.
- `U109`: require explicit threshold-based switch points for optionality/participation/control across at least two uncertainty regimes.
