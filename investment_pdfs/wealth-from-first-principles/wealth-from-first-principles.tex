...
\subsection{Cross-jurisdiction transmission check: ECB and BoJ as counterweights}
\label{subsec:ecb-boj-counterweights}

Money-growth can look synchronized across jurisdictions while transmission differs by legal and banking architecture.
The same question remains practical: where does policy support become durable owner access?

For 2025--2026, use this three-phase check:
\begin{enumerate}
  \item \textbf{Policy signal phase}. Institutions communicated lower-stress frameworks and liquidity conditions.
  \item \textbf{Intermediary response phase}. Banks and lenders adjusted standards and risk appetite by borrower class.
  \item \textbf{Owner-entry phase}. New durable entry and participation moved, or did valuation and headline stability lead the cycle first?
\end{enumerate}
...
\toprule
\textbf{Sequence check} & \textbf{What to observe} & \textbf{Practical implication} \\
\midrule
Policy signal phase & ECB monetary-annex framing and BoJ policy-architecture updates. & Treat policy stabilization as a precondition, not proof of durable owner entry. \\
Intermediary response phase & Lending standards, approval behavior, and portfolio risk appetite by segment. & Keep leverage and concentrated bets conditional until access channels widen. \\
Owner-entry phase & First-time borrower access, small-firm persistence, and debt-service progression. & Only then move from defense to controlled ownership expansion. \\
\bottomrule
\end{tabularx}
\normalsize
\end{center}
...
1. If policy improves but first-time entry and burden are still divergent, keep strategy defensive.\par
2. If policy, intermediary response, and owner-entry improve together for two windows, consider staged scaling.\par
3. If any phase stalls, preserve optionality with fixed-cost restraint and liquidity reserve.
\end{notebox}
...
\begin{itemize}
  \item ECB Monetary Developments Jan 2026: \href{https://www.ecb.europa.eu/press/pdf/md/ecb.md2601_annex~df0e665d8e.en.pdf}{ecb.md2601\_annex}
  \item Bank of Japan Annual Review 2025: \href{https://www.boj.or.jp/en/about/activities/act/data/ar2025.pdf}{AR2025}
  \item IMF WEO press release context, Jan 2026: \href{https://www.imf.org/en/news/articles/2026/01/21/tr-01212026-weo-press-conference-on-release-of-the-january-2026-world-economic-outlook-update}{IMF WEO Jan 2026 launch note}
\end{itemize}
