...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \node[
    ...
    {\fontsize{28}{31}\selectfont\bfseries\color{black!88} 如何实现财务自由\\与建立被动收入\par}
    \vspace{0.8em}
    {\Large\color{black!72} 传统原则、现代工具，以及长期可持续的现金流路径\par}
  };
  \node[
    anchor=south west,
    align=left,
    ...
    {\normalsize\color{black!82} 中文研究版\par}
    \vspace{0.35em}
    {\small\color{black!72} Written and published by LazyingArt LLC.\par}
