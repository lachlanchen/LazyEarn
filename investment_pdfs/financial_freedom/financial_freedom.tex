...
\hypersetup{
    ...
    linkcolor=black,
    urlcolor=black,
    pdftitle={Achieving Financial Freedom},
...
\begin{titlepage}
    ...
    \begin{tikzpicture}[remember picture,overlay]
        ...
        \node[
            ...
            {\fontsize{28}{31}\selectfont\bfseries\color{black!88} Achieving Financial Freedom\par}
            \vspace{0.8em}
            {\Large\color{black!72} Timeless Principles and Modern Strategies\par}
        };
        \node[
            anchor=south west,
            align=left,
            ...
            {\normalsize\color{black!82} Practical guide\par}
            \vspace{0.35em}
